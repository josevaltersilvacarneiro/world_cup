...
TEAM *convert_to_team_ptr(const TEAM **first_team, const String team_name);
...
String get_team(const TEAM **first_team, bool is_in);
size_t get_date();
String get_place(void);

size_t maximum_amount_of_registered_games_group(const TEAM **first_team, char group);
size_t maximum_amount_of_registered_games(const TEAM **first_team, char groups[]);

size_t get_amount_of_registered_teams(const TEAM **first_team, char group);
...
size_t number_of_games_to_register(const TEAM **first_team, GAME *games, char groups[]);
